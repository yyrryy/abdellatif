...
urlpatterns = [
    ...
    # path('brahim', views.brahim, name='brahim'),
    # path('brahim', views.brahim, name='brahim'),
    path('updateplafon', views.updateplafon, name='updateplafon'),
    path('addsupplyfacture', views.addsupplyfacture, name='addsupplyfacture'),
    path('recevoirfacture', views.recevoirfacture, name='recevoirfacture'),
    ...
    path('validerclientcart', checkviews.validerclientcart, name='validerclientcart'),
    # path('cleararrivage', checkviews.cleararrivage, name='cleararrivage'),
    # path('cleararrivage', checkviews.cleararrivage, name='cleararrivage'),
    # path('cleararrivage', checkviews.cleararrivage, name='cleararrivage'),
    # path('cleararrivage', checkviews.cleararrivage, name='cleararrivage'),
